<script lang="ts">
	...
	let styleInput =
		'focus:outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-1 dark:bg-stone-900 dark:placeholder-stone-500 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500';
...
<div>
	<label class="block mb-2 text-sm font-medium text-stone-900 dark:text-gray-300" for={label}
		>{label}</label
	>
	<input
		id={label}
